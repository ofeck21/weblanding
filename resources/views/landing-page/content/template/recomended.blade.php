@foreach($recomended_templates as $template)
                    ...
                    <div class="post-media">
                        <picture>
                            <source media="(max-width: 480px)"
                                ...
                                srcset="{{asset('templates/'.$template->thumbnail)}} 480w">
                            <source media="(max-width: 660px)"
                                sizes="(max-width: 660px) 660px"
                                srcset="{{asset('templates/'.$template->thumbnail)}} 660w">
                            <source media="(max-width: 840px)"
                                sizes="(max-width: 840px) 840px"
                                srcset="{{asset('templates/'.$template->thumbnail)}} 840w">
                            <source media="(max-width: 1020px)"
                                sizes="(max-width: 1020px) 1020px"
                                srcset="{{asset('templates/'.$template->thumbnail)}} 1020w">
                            <source media="(max-width: 1200px)"
                                sizes="(max-width: 1200px) 1200px"
                                srcset="{{asset('templates/'.$template->thumbnail)}} 1200w">
                            <img decoding="async" alt="product-5"
                                title="product-5"
                                src="{{asset('templates/'.$template->thumbnail)}}"
