...
function agencium_customizer_dependancy() {
...
function agencium_customizer_repeater_uniqid(prefix, more_entropy) {
...
function agencium_customizer_repeater_refresh_social_icons(th) {
    ...
    th.find('.customizer-repeater-social-repeater-container').each(function () {
        ...
        if (!id) {
            id = 'customizer-repeater-social-repeater-' + agencium_customizer_repeater_uniqid();
    ...
    agencium_customizer_repeater_refresh_general_control_values();
}

function agencium_customizer_repeater_refresh_general_control_values() {
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            if (!id) {
                id = 'social-repeater-' + agencium_customizer_repeater_uniqid();
            ...
            if ( title !== '' || icon_value !== '' || link !== '' ) {
                values.push({
                    ...
                    'link': link,
                    'title': agencium_escape_html(title),
                    'id': id
                });
            }
        });
...
function agencium_get_resolution_value($element) {
    var selected_values = {
...
function agencium_get_dimensions_value($element) {
    var selected_values = {
...
function agencium_get_font_value($element) {
    var selected_values = {
...
function agencium_ctype_digit(text) {
...
function agencium_escape_html(string) {
...
jQuery(document).ready(function($) {
    ...
    $(document).on('change', '.customize-control select, .customize-control input, .customize-control textarea', function () {
        agencium_customizer_dependancy();
    });
    ...
    */
    $('.customize-control-resolution input[type="number"]').on('change', function() {
        agencium_get_resolution_value( $(this).parents('.customize-control-resolution') );
    });
    ...
    */
    $('.customize-control-dimensions select, .customize-control-dimensions input[type="number"]').on('change', function() {
        agencium_get_dimensions_value( $(this).parents('.customize-control-dimensions') );
    });

    /**
     * Google Font Custom Control
     */
    $('.agencium-google-fonts-list').on('change', function () {
        var elementWeightStyle = $(this).parent().parent().find('.agencium-google-font-styles');
        var elementSubset = $(this).parent().parent().find('.agencium-google-font-subset');
        var elementWeight = $(this).parent().parent().find('.agencium-google-font-weight');
        ...
        $.each(gflist[index].weights, function (val, text) {
            ...
            text = $.trim(text);
            if (optval === selectedWeight && agencium_ctype_digit(optval)) {
                elementWeightStyle.append(
                    $('<option></option>').val(optval).html(text).attr('selected', 'selected')
                ).val(optval).change();
            } else if (agencium_ctype_digit(optval)) {
                elementWeightStyle.append(
                    $('<option></option>').val(optval).html(text)
                );
            }
    ...
    $('.customize-control-google-font select, .customize-control-google-font input[type="number"]').on('change', function() {
        agencium_get_font_value( $(this).parents('.customize-control-google-font') );
    });
...
jQuery(document).ready(function() {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        var id = 'customizer-repeater-' + agencium_customizer_repeater_uniqid();
